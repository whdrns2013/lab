...
python detect_or_trackmbasic_1_3_6.py --weights wild5_retry.pt --no-trace --view-img --source 0 --track --show-track --unique-track-color --danger-range 0.5 --conf-thres 0.7 --detecting-time 10 class 80 81 82 83 84
...
def saving_videos(vid_writer, vid_path, save_dir, im0, vid_cap=None, event_name='1'):
    if vid_path is None or vid_writer is None:
        ...
        vid_writer = cv2.VideoWriter(str(save_dir / f'detect_vid.mp4'), cv2.VideoWriter_fourcc(*'H264'), fps, (w, h))
