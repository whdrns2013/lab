...
webcam = cv2.VideoCapture(0)  # 웹캠 영상을 읽어오기 위한 코드
...
output = cv2.VideoWriter('C:/Users/freef/Desktop/theos/easy-yolov7-main/output.mp4', fourcc, fps, (width, height))
    ...
    with tqdm() as pbar:
        while webcam.isOpened():
            ...
            if ret == True:
                ...
                output.write(frame) # 프레임을 output 파일에 저장
                cv2.imshow('frame',frame) # 화면에 프레임 출력
